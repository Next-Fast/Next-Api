...
internal class RoleMenu
{
    ...
    public static void CreateRoleMenu()
    {
        ...
        Dialogue = Object.Instantiate(HudManager.Instance.Dialogue, HudManager.Instance.transform);
        var renderer = Dialogue.gameObject.transform.GetChild(0).GetComponent<SpriteRenderer>();
        var closeButton = Dialogue.gameObject.transform.GetChild(1).GetComponent<SpriteRenderer>();
        var fullScreen = renderer.transform.GetChild(0).gameObject;
        fullScreen.GetComponent<PassiveButton>().OnClick = new Button.ButtonClickedEvent();
    ...
    public static void AddButton(Vector2 size, string name, string display, GameObject parent, Color color)
    {
        ...
        var text = Object.Instantiate(HudManager.Instance.Dialogue.target);
