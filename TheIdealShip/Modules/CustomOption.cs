...
public class CustomOption
{
    ...
    public static void switchPreset(int newPreset)
    {
        ...
        foreach (var option in options)
        {
            ...
            option.entry =
                TheIdealShipPlugin.Instance.Config.Bind($"Preset{preset}", option.id.ToString(),
...
/*                 gameTab.transform.localScale = Vector3.one;
    ...
    public static class GameOptionsNextPagePatch
    {
        ...
        {
            var optionsPage = TheIdealShipPlugin.OptionPage;
            if (Input.GetKeyDown(KeyCode.Tab)) TheIdealShipPlugin.OptionPage = (TheIdealShipPlugin.OptionPage + 1) % 7;
